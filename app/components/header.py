            ...
            rx.el.div(
                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        ...
                        rx.el.a(
                            "EN", href="#", class_name="text-xs font-bold text-white"
                        ),
                        class_name="flex items-center",
                    ),
                    rx.el.button(
                ...
                class_name="container mx-auto px-4 lg:px-6 flex justify-between items-center",
            ),
            class_name="w-full py-2 border-b border-white/10",
        ),
        rx.el.div(
            rx.el.div(
                rx.el.a(
